...
reads its *own* module globals.  (Two submodule-local knobs remain where
...
``ROCQ_DEBUG_ENRICHMENT`` in ``envelope.py`` — they move here when the
full server decomposition lands.)
